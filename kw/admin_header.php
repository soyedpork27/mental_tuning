...
<header>
      ...
      <nav>
        <ul class="nav-lv1">
          ...
          <li><a href="./user_list.php"><img src="../images/icon_user.png" alt="회원 관리">회원 관리</a></li>
          <li class="nav-open">
            <a href="#none"><img src="../images/icon_class.png" alt="클래스 관리">클래스 관리</a>
            <ul class="nav-lv2">
              <li><a href="../hyun/class_open.html" title="">클래스 신청내역</a></li>
              <li><a href="./class_list.php">클래스 개설목록</a></li>
            </ul>
          </li>
          <li class="nav-open">
